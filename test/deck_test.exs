defmodule DeckTest do
  ...
  # A sigil, not a list literal: the formatter rewrites a 52-element list into 52
  # lines and loses the rank-by-suit grid, which is the reason for writing the
  # expected deck out by hand rather than deriving it from Deck.new/0.
  @ordered_deck ~w[
